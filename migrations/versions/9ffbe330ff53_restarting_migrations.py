...
def upgrade():
    ...
    sa.Column('required_supplier_approval', sa.Boolean(), nullable=True),
    sa.Column('required_client_approval', sa.Boolean(), nullable=True),
    ...
    sa.Column('company_category', sa.String(length=16), nullable=True),
